...
# Esta es la parte de Gradio que "envuelve" nuestra aplicación Flask
# Hugging Face Spaces detectará esta interfaz de Gradio y la lanzará.
with gr.Blocks(title="Taby Tutora de Matemática") as demo:
    # Incrustamos la aplicación Flask/HTML en un iframe que apunta a la raíz de Flask
    gr.HTML(value="""
        <iframe src="/" style="width: 100%; height: 100vh; border: none;"></iframe>
    """)

# Lanzamos la demo en el puerto asignado por el entorno (por defecto 7860)
if __name__ == "__main__":
    # Importante: Gradio y Flask deben convivir. demo.launch() maneja el servidor.
